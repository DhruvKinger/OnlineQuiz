...
# ONLINE QUIZ
Under this  project we have a maintained Online Portal where user can come and give Quiz on different technologies.He can choose his Topic say like Current Affairs,Dotnet,Machine Learning and so on.He will be having a fix time to do so.Once time is over his session Expires and score is displayed.Next time if User comes he can check the his previous test records.
